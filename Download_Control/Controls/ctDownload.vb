...
Public Class ctDownload
    ...
    Private Sub ResizeControls()
        Try
            ...
            Dim intY As Integer = (Me.Height - 40)

            panDownload.Location = New System.Drawing.Point(0, 35)
            panDownload.Size = New System.Drawing.Size(intX, intY)

            lblSource.Location = New System.Drawing.Point(1, 7)
            lblSource.Size = New System.Drawing.Size(74, 13)

            btnBrowse.Location = New System.Drawing.Point((Me.Width - 70), 4)
            btnBrowse.Size = New System.Drawing.Size(63, 23)

            txtSource.Location = New System.Drawing.Point(79, 6)
            txtSource.Size = New System.Drawing.Size((Me.Width - 145), 20)
        Catch ex As Exception
    ...
    Private Function GetSelectedXMLNodes(ByVal FileName As String, ByVal TagName As String) As List(Of DownloadItem)
        ...
        Try
            ...
            Dim Request As WebRequest = HttpWebRequest.Create(FileName)
    ...
    ''' The download path.
    ''' </value>
    Public WriteOnly Property DownloadPath() As String
        Set(ByVal Value As String)
            DIR_TO_SAVE_MESSAGE = Value
        End Set
    End Property
    ...
    ''' The source path.
    ''' </value>
    Public WriteOnly Property SourcePath() As String
        Set(ByVal Value As String)
            SOURCE_FILE_FOR_TEMPLATE = Value
        End Set
    End Property
End Class
